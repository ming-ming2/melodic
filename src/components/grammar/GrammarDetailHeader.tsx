// components/grammar/GrammarDetailHeader.tsx
...
export default function GrammarDetailHeader({
  title,
  totalItems,
  todayTarget,
  todayLearned,
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* 통계 버튼 */}
          <button className="p-2 rounded-lg transition-colors text-gray-400 hover:bg-gray-800 hover:text-white">
      ...
      <div className="bg-gray-800 rounded-lg p-4 relative">
        ...
        <div className="flex justify-between mt-4">
          <div>
            <p className="text-sm text-gray-400">전체 문법</p>
